import { reportingAgent, getRun, internalAuthorized, json } from './_shared/natcorp-runtime.mjs';
export default async (req) => {
  ...
  try {
    ...
    const output = await reportingAgent({ runId:body.run_id, run, input:body.input || {} });
