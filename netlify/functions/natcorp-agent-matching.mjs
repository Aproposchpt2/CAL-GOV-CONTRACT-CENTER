import { matchingAgent, getRun, internalAuthorized, json } from './_shared/natcorp-runtime.mjs';
export default async (req) => {
  ...
  try {
    ...
    const output = await matchingAgent({ runId:body.run_id, run, input:body.input || {} });
